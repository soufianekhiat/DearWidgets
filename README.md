...
- **Dashed polylines** — CPU or GPU anti-aliased dashed lines
...
- **Procedural color** — ShaderToy-style 1D/2D CPU-evaluated color functions
...
- **DrawText / CalcTextSize** — resolution-independent glyph rendering from Bézier outlines (no atlas, no SDF)
- **Color fonts** — full COLR v0/v1 support (color layers, gradients)
- **Gradient and image text fills** — tessellated outline fills with arbitrary gradients
